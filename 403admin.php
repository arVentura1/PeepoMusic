...
<section class="page-section bg-primary text-white mb-0" id="about">
    <div class="container">
        <h4 class="page-section-heading text-center text-uppercase text-white"><?= $lang['onlyAdmin'] ?></h4>
        ...
        <div class="error-img">
            <img src="./assets/img/fotos/errorAdmin.png" width="450" height="350" alt="peepo-error">
        </div>
    </div>
</section>
